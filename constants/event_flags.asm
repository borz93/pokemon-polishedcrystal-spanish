...
; Haunted Radio Tower
	const EVENT_HAUNTED_RADIO_TOWER_GASTLY
	const EVENT_HAUNTED_RADIO_TOWER_HAUNTER
	const EVENT_HAUNTED_RADIO_TOWER_GENGAR
	const EVENT_HAUNTED_RADIO_TOWER_DIARY_1
	const EVENT_HAUNTED_RADIO_TOWER_DIARY_2
	const EVENT_HAUNTED_RADIO_TOWER_DIARY_3
	const EVENT_HAUNTED_RADIO_TOWER_FAKE_EMPLOYEE
	const EVENT_HAUNTED_RADIO_TOWER_TRAPDOOR
	const EVENT_HAUNTED_RADIO_TOWER_MET_SHADOW
	const EVENT_GOT_MASTER_BALL_FROM_MR_FUJI
